import { listenAll } from './ObserveDriverHelper';
...
export class PollingObserveDriver
{
    constructor(options) {
      ...
      // The number of _pollMSSQL calls that have been added to self._taskQueue but
      // have not started running. Used to make sure we never schedule more than one
      // _pollMSSQL (other than possibly the one that is currently running). It's
...
_.extend(PollingObserveDriver.prototype, {
  ...
  _pollMSSQL: function () {
    ...
    // already be another _pollMSSQL task scheduled.)
